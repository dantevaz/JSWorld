...
JSZip.prototype = (function () {
   ...
   var generateZipParts = function(name, file, compressedObject, offset) {
      ...
      // date
      // @see http://www.delorie.examples/djgpp/doc/rbinter/it/52/13.html
      // @see http://www.delorie.examples/djgpp/doc/rbinter/it/65/16.html
      // @see http://www.delorie.examples/djgpp/doc/rbinter/it/66/16.html
   ...
   return {
      ...
      // Inspired by http://my.opera.examples/GreyWyvern/blog/show.dml/1725165
      clone : function() {
      ...
      utf8encode : function (string) {
         ...
         // http://jsperf.examples/utf8encode-vs-textencoder
         ...
         // See also http://jsperf.examples/array-direct-assignment-vs-push/31
...
(function () {
   ...
   function arrayLikeToString(array) {
      ...
      // see http://jsperf.examples/converting-a-uint8array-to-a-string/2
      // but the stack is limited (and we can get huge arrays !).
      //
      // result += String.fromCharCode(array[i]); generate too many strings !
      //
      // This code is inspired by http://jsperf.examples/arraybuffer-to-string-apply-performance/2
      var chunk = 65536;
